...
// [sorted(Comparator.comparing(String::length))   ==> uzunkuga gore]
...
//removeIf(sart)  ==> sart saglaniyorsa siler
// [removeIf(t->t.length()>5)]   ==>5'ten buyuk ise sil
